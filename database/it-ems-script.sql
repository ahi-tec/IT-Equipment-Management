-- =============================================
-- IT Equipment Management System - Database Script
-- SQL Server 2019+
-- Version: 1.0
...
-- Notification Configs (English subjects for v1.0)
...
BEGIN
    ...
    ('ChecklistAssigned', 'Checklist Assigned', 1, 'Send notification when assigned to inspect a Checklist', '[Checklist] You have been assigned for inspection - {code}', 'Immediate', '07:00', 0),
